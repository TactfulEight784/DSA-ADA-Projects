...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#2fab7c30#;
   ...
   u00123 : constant Version_32 := 16#d4da820d#;
   pragma Export (C, u00123, "distribution_serviceB");
   u00124 : constant Version_32 := 16#3a1b4520#;
   pragma Export (C, u00124, "distribution_serviceS");
   u00125 : constant Version_32 := 16#ffaa9e94#;
   pragma Export (C, u00125, "ada__calendar__delaysB");
   u00126 : constant Version_32 := 16#d86d2f1d#;
   pragma Export (C, u00126, "ada__calendar__delaysS");
   u00127 : constant Version_32 := 16#48583e4e#;
   pragma Export (C, u00127, "ada__calendarB");
   u00128 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00128, "ada__calendarS");
   u00129 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00129, "system__os_primitivesB");
   u00130 : constant Version_32 := 16#280734e2#;
   pragma Export (C, u00130, "system__os_primitivesS");
   u00131 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00131, "system__arith_64B");
   u00132 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00132, "system__arith_64S");
   u00133 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00133, "system__task_lockB");
   u00134 : constant Version_32 := 16#4e70667a#;
   pragma Export (C, u00134, "system__task_lockS");
   u00135 : constant Version_32 := 16#b8c476a4#;
   pragma Export (C, u00135, "system__win32__extS");
   ...
   u00172 : constant Version_32 := 16#f2c63a02#;
   pragma Export (C, u00172, "ada__numericsS");
   u00173 : constant Version_32 := 16#d976e2b4#;
   pragma Export (C, u00173, "ada__numerics__float_randomB");
   u00174 : constant Version_32 := 16#077f89fa#;
   pragma Export (C, u00174, "ada__numerics__float_randomS");
   u00175 : constant Version_32 := 16#0774605b#;
   pragma Export (C, u00175, "system__random_numbersB");
   u00176 : constant Version_32 := 16#19a1600c#;
   ...
   u00178 : constant Version_32 := 16#c3b30278#;
   pragma Export (C, u00178, "system__random_seedS");
   u00179 : constant Version_32 := 16#bf13658b#;
   pragma Export (C, u00179, "food_datastructuresB");
   u00180 : constant Version_32 := 16#4ae80f5f#;
   pragma Export (C, u00180, "food_datastructuresS");
   u00181 : constant Version_32 := 16#928a8705#;
   pragma Export (C, u00181, "ada__text_io__enumeration_auxB");
   u00182 : constant Version_32 := 16#c468c016#;
   ...
   u00184 : constant Version_32 := 16#d2eb439d#;
   pragma Export (C, u00184, "gatekeeperserviceB");
   u00185 : constant Version_32 := 16#7d570858#;
   pragma Export (C, u00185, "gatekeeperserviceS");
   u00186 : constant Version_32 := 16#9ccc2736#;
   pragma Export (C, u00186, "doublestackB");
   u00187 : constant Version_32 := 16#88f2572f#;
   pragma Export (C, u00187, "doublestackS");
   u00188 : constant Version_32 := 16#47ae2d21#;
   pragma Export (C, u00188, "system__img_fixed_64S");
   u00189 : constant Version_32 := 16#2d8c0d8e#;
   pragma Export (C, u00189, "system__exn_lliS");
   u00190 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00190, "system__taskingB");
   u00191 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00191, "system__taskingS");
   u00192 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00192, "system__task_primitivesS");
   u00193 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00193, "system__os_interfaceS");
   u00194 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00194, "interfaces__c__stringsB");
   u00195 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00195, "interfaces__c__stringsS");
   u00196 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00196, "system__task_primitives__operationsB");
   u00197 : constant Version_32 := 16#9723968e#;
   pragma Export (C, u00197, "system__task_primitives__operationsS");
   u00198 : constant Version_32 := 16#6387a759#;
   pragma Export (C, u00198, "system__interrupt_managementB");
   u00199 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00199, "system__interrupt_managementS");
   u00200 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00200, "system__multiprocessorsB");
   u00201 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00201, "system__multiprocessorsS");
   u00202 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00202, "system__task_infoB");
   u00203 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00203, "system__task_infoS");
   u00204 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00204, "system__tasking__debugB");
   u00205 : constant Version_32 := 16#d3b35c55#;
   pragma Export (C, u00205, "system__tasking__debugS");
   u00206 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00206, "system__concat_2B");
   u00207 : constant Version_32 := 16#2d5a86c4#;
   pragma Export (C, u00207, "system__concat_2S");
   u00208 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00208, "system__concat_3B");
   u00209 : constant Version_32 := 16#248a0db1#;
   pragma Export (C, u00209, "system__concat_3S");
   u00210 : constant Version_32 := 16#617d5887#;
   pragma Export (C, u00210, "system__stack_usageB");
   u00211 : constant Version_32 := 16#8d63b971#;
   pragma Export (C, u00211, "system__stack_usageS");
   u00212 : constant Version_32 := 16#2ebb1120#;
   pragma Export (C, u00212, "system__tasking__rendezvousB");
   u00213 : constant Version_32 := 16#da433d5e#;
   pragma Export (C, u00213, "system__tasking__rendezvousS");
   u00214 : constant Version_32 := 16#100eaf58#;
   pragma Export (C, u00214, "system__restrictionsB");
   u00215 : constant Version_32 := 16#45aa48e1#;
   pragma Export (C, u00215, "system__restrictionsS");
   u00216 : constant Version_32 := 16#886988be#;
   pragma Export (C, u00216, "system__tasking__entry_callsB");
   u00217 : constant Version_32 := 16#526fb901#;
   pragma Export (C, u00217, "system__tasking__entry_callsS");
   u00218 : constant Version_32 := 16#d499f4ac#;
   pragma Export (C, u00218, "system__tasking__initializationB");
   u00219 : constant Version_32 := 16#cd0eb8a9#;
   pragma Export (C, u00219, "system__tasking__initializationS");
   u00220 : constant Version_32 := 16#2e7731ce#;
   pragma Export (C, u00220, "system__soft_links__taskingB");
   u00221 : constant Version_32 := 16#e939497e#;
   pragma Export (C, u00221, "system__soft_links__taskingS");
   u00222 : constant Version_32 := 16#3880736e#;
   pragma Export (C, u00222, "ada__exceptions__is_null_occurrenceB");
   u00223 : constant Version_32 := 16#5ca174ae#;
   pragma Export (C, u00223, "ada__exceptions__is_null_occurrenceS");
   u00224 : constant Version_32 := 16#132211d8#;
   pragma Export (C, u00224, "system__tasking__task_attributesB");
   u00225 : constant Version_32 := 16#7dbadc03#;
   pragma Export (C, u00225, "system__tasking__task_attributesS");
   u00226 : constant Version_32 := 16#ac06ab59#;
   pragma Export (C, u00226, "system__tasking__protected_objectsB");
   u00227 : constant Version_32 := 16#242da0e0#;
   pragma Export (C, u00227, "system__tasking__protected_objectsS");
   u00228 : constant Version_32 := 16#d5216b8e#;
   pragma Export (C, u00228, "system__tasking__protected_objects__entriesB");
   u00229 : constant Version_32 := 16#7daf93e7#;
   pragma Export (C, u00229, "system__tasking__protected_objects__entriesS");
   u00230 : constant Version_32 := 16#ef7f0714#;
   pragma Export (C, u00230, "system__tasking__protected_objects__operationsB");
   u00231 : constant Version_32 := 16#07408f44#;
   pragma Export (C, u00231, "system__tasking__protected_objects__operationsS");
   u00232 : constant Version_32 := 16#1f882186#;
   pragma Export (C, u00232, "system__tasking__queuingB");
   u00233 : constant Version_32 := 16#73e13001#;
   pragma Export (C, u00233, "system__tasking__queuingS");
   u00234 : constant Version_32 := 16#acbd1abf#;
   pragma Export (C, u00234, "system__tasking__utilitiesB");
   u00235 : constant Version_32 := 16#6b757be7#;
   pragma Export (C, u00235, "system__tasking__utilitiesS");
   u00236 : constant Version_32 := 16#ead5bc8c#;
   pragma Export (C, u00236, "system__tasking__stagesB");
   u00237 : constant Version_32 := 16#6153a6f3#;
   pragma Export (C, u00237, "system__tasking__stagesS");
   u00238 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00238, "ada__real_timeB");
   u00239 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00239, "ada__real_timeS");
   u00240 : constant Version_32 := 16#01e11dac#;
   pragma Export (C, u00240, "stats_fooddistributionB");
   u00241 : constant Version_32 := 16#8976bb4e#;
   pragma Export (C, u00241, "stats_fooddistributionS");
   u00242 : constant Version_32 := 16#213c2f0b#;
   pragma Export (C, u00242, "food_salesserviceB");
   u00243 : constant Version_32 := 16#31d73acb#;
   pragma Export (C, u00243, "food_salesserviceS");
   u00244 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00244, "system__memoryB");
   u00245 : constant Version_32 := 16#76873720#;
